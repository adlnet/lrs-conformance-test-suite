...
(function (process, request, should, helper, qs, validUrl) {
    ...
    describe('Document API Requirements', function () {
        ...
        describe('An LRS cannot reject a POST request to the State API based on the contents of the name/value pairs of the document (7.3.b) **Implicit**', function (done) {
            var parameters = helper.buildState(),
                documents = [helper.buildDocument(), 1, true, undefined];
        ...
        it('An LRS\'s returned array of ids from a successful GET request all refer to documents stored after the TimeStamp in the "since" parameter of the GET request (7.4.table2.row4)', function () {
            var parameters = helper.buildState(),
                document = helper.buildDocument(),
                anotherDocument = helper.buildDocument();
            var anotherParameters = helper.clone(parameters);
        ...
        it('Any LRS API that accepts a POST request can accept a POST request with a single query string parameter named "method" on that request (7.8.a)', function () {
            ...
            return sendRequest('post', '/statements', parameters, formBody, 200);
        });
        ...
        it('An LRS will map form parameters from the body of the Cross Origin Request to the similarly named HTTP Headers in the new Request (7.8.b)', function () {
            ...
            return sendRequest('post', '/statements', parameters, formBody, 200)
                .then(function (res) {
                    ...
                    formBody = buildFormBody();
                    formBody['statementId'] = res.body[0];
                    return sendRequest('post', '/statements', parameters, undefined, 200);
                });
        });
        ...
        it('An LRS rejects a new Request in the same way for violating rules of this document as it would a normal Request **Implicit**', function () {
            ...
            return sendRequest('post', '/statements', parameters, formBody, 400);
        });
        ...
        it('An LRS will reject a new Request which attempts to send attachment data with error code 400 Bad Request (7.8.d)', function () {
        ...
        it('An LRS responds to a HEAD request in the same way as a GET request, but without the message-body (7.10.a, 7.10.a.a) **This means run ALL GET tests with HEAD**', function () {
            // TODO Find a good solution for testing all combinations of this
            return sendRequest('head', '/statements', undefined, undefined, 200)
                .then(function (res) {
                    res.body.should.eql({});
                });
        ...
        it('An LRS accepts HEAD requests without Content-Length headers (7.10.a.b)', function () {
            return sendRequest('head', '/statements', undefined, undefined, 200)
                .then(function (res) {
                    res.body.should.eql({});
                });
