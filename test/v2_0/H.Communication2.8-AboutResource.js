                ...
                request(helper.getEndpointAndAuth())
                    ...
                    .end(function (err, res) {
                        if (err) {
                            ...
                            // If the status code is a 200, we expect that the request was rerouted to a 1.0.x or 0.9x compliant LRS
                            // and test for that version in the result headers.
                            ...
                            str += '.\nExpected: Either 400 with LRS version 2.0.x, or 200 with LRS version 0.9x or 1.0.x.';
                            done(new Error(str));
                        }
                    });
            });
